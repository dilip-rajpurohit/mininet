...
def topology(args):
    ...
    log_file = open("exp8_handover_log.txt", "w")
    ...
    # Log the AP association and track handovers only at 10s, 35s, and 65s
    for t in range(5, 70, 5):
        if t in [10, 35, 65]:  # Only log at 10s, 35s, and 65s
